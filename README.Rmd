...
This package was created to use it on restaurants, bars, etc... located in Ushuaia city, Tierra del Fuego, Argentina. You can retrieve a vector of them with the next code:
